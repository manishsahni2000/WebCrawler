<html>
<body>
	<H1>Search in JSON</H1>
	<form action="/applicant/manishsahni/SearchableJSONController" method="post">
		<table>
			<tr>
				<td>Search here</td>
				<td><input type="text" name="search_key" id="search_key"></td>
			</tr>
			<tr>
				<td><input type="radio" name="search_type" value="E">
					Exact Search</td>
				<td><input type="radio" name="search_type" value="P">
					Partial Search</td>
				<td><input type="radio" name="search_type" value="N">
					Negative Search</td>
...
<script type="text/javascript">
	...
	alert('here ' + json.Name)
	$.each(json.Name, function(i, v) {
		if (v.Name == "zsh") {
			alert(v.Type);
			return;
		}
